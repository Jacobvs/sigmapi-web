...
class PublicViewTests(TestCase):
    ...
    def test_brothers_page(self):
        ...
        class_to_year_mappings = {'Graduate Students': senior_year-1, 'Seniors': senior_year, 'Juniors': senior_year+1, 'Sophomores': senior_year+2, 'Freshmen': senior_year+2}
        ...
        for brother_group in response.context['brother_groups']:
            ...
            returned_num_brothers[brother_group['group_title']] = len(brother_group['brothers'])
        ...
        for key in class_to_year_mappings:
            try:
                self.assertEqual(grad_years[class_to_year_mappings[key]], returned_num_brothers[key])
