...
urlpatterns = [
    ...
    url(regex=r"^clique/create/$", view=api.clique_create, name="slack_clique-create"),
    url(regex=r"^clique/send/$", view=api.clique_send_msg, name="slack_clique-send"),
    url(
    ...
    url(regex=r"^clique/delete/$", view=api.clique_delete, name="slack_clique-delete"),
    url(regex=r"^clique/list/$", view=api.clique_list, name="slack_clique-list"),
]
