    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bone",
                    models.ForeignKey(to="Standards.Bone", on_delete=models.CASCADE),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        max_length=1,
                        choices=[
                            (b"P", b"Pre/Post Party Job (10)"),
                            (b"F", b"First Shift Party Job (30)"),
                            (b"S", b"Second Shift Party Job (40)"),
                            (b"H", b"House Job (20)"),
                            (b"M", b"Meal Crew (20)"),
                        ],
                    ),
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        max_length=1,
                        choices=[
                            (b"P", b"Pre/Post Party Job"),
                            (b"F", b"First Shift Party Job"),
                            (b"S", b"Second Shift Party Job"),
                            (b"H", b"House Job"),
                            (b"M", b"Meal Crew"),
                        ],
                    ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="Standards.PiPointsRecord", on_delete=models.CASCADE
            ),
