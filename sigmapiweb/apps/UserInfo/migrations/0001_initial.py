    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phoneNumber",
                    models.CharField(default=b"", max_length=100, blank=True),
                ),
                ("graduationYear", models.PositiveIntegerField(default=2015)),
                (
                    "classYear",
                    models.CharField(default=b"Lambda", max_length=20, blank=True),
                ),
                ...
                (
                    "pledgeClass",
                    models.ForeignKey(
                        to="UserInfo.PledgeClass", on_delete=models.CASCADE
                    ),
                ),
                (
                    "user",
